<div class="content-wrapper">
    <section class="content-header">
        <h1><i class="fa fa-calculator"></i> Balance Sheet</h1>
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo site_url('accounts/reports/balancesheet') ?>" method="post" class="">
                ...
                <?php if (isset($result)) { ?>
                    <div class="box box-info" id="report-card">
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-list"></i> Balance Sheet as on <?php echo isset($date_to) ? $date_to : ''; ?></h3>
                            <div class="box-tools pull-right">
                                ...
                                <button type="button" class="btn btn-default btn-xs" onclick="exportToExcel('Balance_Sheet_Report')"><i class="fa fa-file-excel-o"></i> Excel</button>
                            </div>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 border-right">
                                    <h4 class="text-danger"><b>Liabilities & Capital</b></h4>
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php foreach ($result['liabilities'] as $liab) { ?>
                                                <tr>
                                                    <td><?php echo $liab['name']; ?> <small class="text-muted">(<?php echo $liab['group']; ?>)</small></td>
                                                    <td class="text-right"><?php echo number_format($liab['amount'], 2); ?></td>
                                                </tr>
                                            <?php } ?>
                                            <?php if (empty($result['liabilities'])) { ?>
                                                <tr>
                                                    <td colspan="2" class="text-center text-muted">No liabilities or capital recorded</td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                        <tfoot>
                                            <tr style="background-color: #f9f9f9;">
                                                <th><b>Total Liabilities</b></th>
                                                <th class="text-right"><b><?php echo number_format($result['total_liabilities'], 2); ?></b></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                                ...
                                <!-- Assets Column -->
                                <div class="col-md-6">
                                    <h4 class="text-success"><b>Assets</b></h4>
                                    <table class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>Particulars</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($result['assets'] as $asset) { ?>
                                                <tr>
                                                    <td><?php echo $asset['name']; ?> <small class="text-muted">(<?php echo $asset['group']; ?>)</small></td>
                                                    <td class="text-right"><?php echo number_format($asset['amount'], 2); ?></td>
                                                </tr>
                                            <?php } ?>
                                            <?php if (empty($result['assets'])) { ?>
                                                <tr>
                                                    <td colspan="2" class="text-center text-muted">No assets recorded</td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                        <tfoot>
                                            <tr style="background-color: #f9f9f9;">
                                                ...
                                                <th class="text-right"><b><?php echo number_format($result['total_assets'], 2); ?></b></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
