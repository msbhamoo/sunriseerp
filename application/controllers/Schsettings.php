...
class Schsettings extends Admin_Controller
{
    ...
    public function fees()
    {
        ...
        if(!$custom_receipt_settings) {
            $this->db->insert('custom_receipt_settings', ['id' => 1]);
            $custom_receipt_settings = $this->db->get('custom_receipt_settings')->row();
        }
    ...
    public function savefees()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $existing_custom_receipt_settings = $this->db->get('custom_receipt_settings')->row();
            
            $custom_receipt_data = array(
                'common_prefix' => $this->input->post('common_prefix'),
                'common_start' => $this->input->post('common_start'),
                'transport_prefix' => $this->input->post('transport_prefix'),
                'transport_start' => $this->input->post('transport_start'),
            );
            
            if ($existing_custom_receipt_settings) {
                if ($existing_custom_receipt_settings->common_start != $custom_receipt_data['common_start']) {
