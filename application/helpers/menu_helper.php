...
if (!function_exists('main_menu_array')) {
    ...
    {  
        $array = array(
            ...
            'accounts' => array(               
                'expensetype'      => array('index','edit'),               
                'ledgermaster'     => array('index','edit'),               
                'purchaseentry'    => array('index'),               
                'paymentvoucher'   => array('index'),               
                'receiptvoucher'   => array('index'),               
                'contravoucher'    => array('index'),               
                'journalvoucher'   => array('index'),               
