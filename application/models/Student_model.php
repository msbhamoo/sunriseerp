...
class Student_model extends MY_Model
{
    ...
    public function getBirthDayStudents($date, $email = false, $contact_no = false)
    {
        ...
        $this->db->select('classes.id AS `class_id`,student_session.id as student_session_id,students.id,classes.class,sections.id AS `section_id`,sections.section,students.id,students.admission_no,students.roll_no,students.admission_date,students.firstname,students.middlename,  students.lastname,students.image,students.mobileno,students.email ,students.state,students.city,students.pincode,students.religion,students.dob ,students.current_address,students.permanent_address,IFNULL(students.category_id, 0) as `category_id`,IFNULL(categories.category, "") as `category`,students.adhar_no,students.samagra_id,students.bank_account_no,students.bank_name, students.ifsc_code,students.guardian_name, students.guardian_relation,students.guardian_phone,students.guardian_address,students.is_active ,students.created_at ,students.updated_at,students.father_name,students.rte,students.admission_type,students.gender,users.id as `user_tbl_id`,users.username,users.password as `user_tbl_password`,users.is_active as `user_tbl_active`,students.app_key,students.parent_app_key')->from('students');
    ...
    {
        $this->db->select('classes.id AS `class_id`,student_session.id as student_session_id,students.id,classes.class,sections.id AS `section_id`,sections.section,students.id,students.admission_no , students.roll_no,students.admission_date,students.firstname,  students.middlename,students.lastname,students.image,    students.mobileno, students.email ,students.state ,   students.city , students.pincode ,     students.religion,     students.dob ,students.current_address,    students.permanent_address,IFNULL(students.category_id, 0) as `category_id`,IFNULL(categories.category, "") as `category`,students.adhar_no,students.samagra_id,students.bank_account_no,students.bank_name, students.ifsc_code , students.guardian_name , students.app_key ,students.guardian_relation,students.guardian_phone,students.guardian_address,students.is_active ,students.created_at ,students.updated_at,students.father_name,students.rte,students.admission_type,students.gender,users.id as `user_tbl_id`,users.username,users.password as `user_tbl_password`,users.is_active as `user_tbl_active`')->from('students');
        $this->db->join('student_session', 'student_session.student_id = students.id');
        $this->db->join('classes', 'student_session.class_id = classes.id');
        $this->db->join('sections', 'sections.id = student_session.section_id');
        $this->db->join('categories', 'students.category_id = categories.id', 'left');
    ...
    public function getStudentByClassSectionID($class_id = null, $section_id = null, $id = null, $session_id = null)
    {
        ...
        $this->db->select('pickup_point.name as pickup_point_name,student_session.route_pickup_point_id,student_session.vehroute_id,vehicle_routes.route_id,vehicle_routes.vehicle_id,transport_route.route_title,vehicles.vehicle_no,hostel_rooms.room_no,vehicles.driver_name,vehicles.driver_contact,hostel.id as `hostel_id`,hostel.hostel_name,room_types.id as `room_type_id`,room_types.room_type,students.hostel_room_id,student_session.id as `student_session_id`,student_session.fees_discount,classes.id AS `class_id`,classes.class,sections.id AS `section_id`,sections.section,students.id,students.admission_no,students.roll_no,students.admission_date,students.firstname, students.middlename,students.lastname,students.image,students.mobileno,students.email,students.state,students.city,students.pincode, students.note, students.religion,students.cast,school_houses.house_name,students.dob,students.current_address,students.previous_school,
            ...
            students.permanent_address,students.category_id,students.adhar_no,students.samagra_id,students.bank_account_no,students.bank_name, students.ifsc_code,students.guardian_name,students.father_pic,students.height,students.weight,students.measurement_date, students.mother_pic,students.guardian_pic, students.guardian_relation,students.guardian_phone,students.guardian_address,students.is_active,students.created_at ,students.updated_at,students.father_name,students.father_phone,students.blood_group,students.school_house_id,students.father_occupation,students.mother_name,students.mother_phone,students.mother_occupation,students.guardian_occupation,students.gender,students.guardian_is,students.rte,students.admission_type,students.guardian_email,sessions.session, users.username,users.password,students.dis_reason,students.dis_note,students.app_key,students.parent_app_key')->from('students');
        $this->db->join('student_session', 'student_session.student_id = students.id');
    ...
    {
        $this->db->select('pickup_point.name as pickup_point_name,student_session.route_pickup_point_id,student_session.vehroute_id,student_session.transport_fees,students.app_key,vehicle_routes.route_id,vehicle_routes.vehicle_id,transport_route.route_title,vehicles.vehicle_no,hostel_rooms.room_no,vehicles.driver_name,vehicles.driver_contact,hostel.id as `hostel_id`,hostel.hostel_name,room_types.id as `room_type_id`,room_types.room_type ,students.hostel_room_id,student_session.id as `student_session_id`,student_session.fees_discount,classes.id AS `class_id`,classes.class,sections.id AS `section_id`,sections.section,class_sections.id as `class_section_id`,students.id,students.admission_no, students.roll_no,students.admission_date,students.firstname,students.middlename,students.lastname,students.image,students.mobileno, students.email ,students.state,students.city,students.pincode,students.note, students.religion, students.cast, school_houses.house_name,students.dob ,students.current_address,students.previous_school,students.guardian_is,students.parent_id,          students.permanent_address,students.category_id,students.adhar_no,students.samagra_id,students.bank_account_no,students.bank_name, students.ifsc_code ,students.guardian_name ,students.father_pic ,students.height ,students.weight,students.measurement_date, students.mother_pic ,students.guardian_pic ,students.guardian_relation,students.guardian_phone,students.guardian_address,students.is_active ,students.created_at ,students.updated_at,students.father_name,students.father_phone,students.blood_group,students.school_house_id,students.father_occupation,students.mother_name,students.mother_phone,students.mother_occupation,students.guardian_occupation,students.gender,students.guardian_is,students.rte,students.admission_type,students.guardian_email, users.username,users.password,students.dis_reason,students.dis_note,students.app_key,students.parent_app_key,students.is_staff_kid,students.staff_id')->from('students');
        $this->db->join('student_session', 'student_session.student_id = students.id');
        $this->db->join('classes', 'student_session.class_id = classes.id');
        $this->db->join('sections', 'sections.id = student_session.section_id');
    ...
    {
        $this->db->select('pickup_point.name as pickup_point_name,student_session.route_pickup_point_id,student_session.transport_fees,students.app_key,students.parent_app_key,student_session.vehroute_id,vehicle_routes.route_id,vehicle_routes.vehicle_id,transport_route.route_title,vehicles.vehicle_no,hostel_rooms.room_no,vehicles.driver_name,vehicles.driver_contact,vehicles.vehicle_model,vehicles.manufacture_year,vehicles.driver_licence,vehicles.vehicle_photo,hostel.id as `hostel_id`,hostel.hostel_name,room_types.id as `room_type_id`,room_types.room_type ,students.hostel_room_id,student_session.id as `student_session_id`,student_session.fees_discount,classes.id AS `class_id`,classes.class,sections.id AS `section_id`,sections.section,students.id,students.admission_no,students.roll_no,students.admission_no,students.admission_date,students.firstname,students.middlename, students.lastname,students.image,students.mobileno, students.email ,students.state,students.city,students.pincode,students.note,students.religion,students.cast, school_houses.house_name,students.dob,students.current_address,students.previous_school,students.guardian_is,students.parent_id,  students.permanent_address,students.category_id,students.adhar_no,students.samagra_id,students.bank_account_no,students.bank_name, students.ifsc_code,students.guardian_name,students.father_pic ,students.height,students.weight,students.measurement_date, students.mother_pic,students.guardian_pic,students.guardian_relation,students.guardian_phone,students.guardian_address,students.is_active ,students.created_at ,students.updated_at,students.father_name,students.father_phone,students.blood_group,students.school_house_id,students.father_occupation,students.mother_name,students.mother_phone,students.mother_occupation,students.guardian_occupation,students.gender,students.guardian_is,students.rte,students.admission_type,students.guardian_email, users.username,users.password,users.id as user_id,students.dis_reason,students.dis_note,students.disable_at,students.about,students.designation,class_sections.id as `class_section_id`, students.is_staff_kid, students.staff_id, staff.name as staff_name, staff.surname as staff_surname, staff.employee_id as staff_employee_id')->from('students');
    ...
    public function search_alumniStudent($class_id = null, $section_id = null, $session_id = null)
    {
        ...
        $this->db->select('classes.id AS `class_id`,student_session.id as student_session_id,students.id,GROUP_CONCAT(classes.class,"(",sections.section,")") as class,sections.id AS `section_id`,students.id,students.admission_no,students.roll_no,students.admission_date,students.firstname,students.middlename,students.lastname,students.image,students.mobileno,students.email,students.state,students.city, students.pincode,students.religion,students.dob,students.current_address,    students.permanent_address,IFNULL(students.category_id, 0) as `category_id`,IFNULL(categories.category, "") as `category`,students.adhar_no,students.samagra_id,students.bank_account_no,students.bank_name,students.ifsc_code , students.guardian_name,students.guardian_relation,students.guardian_phone,students.guardian_address,students.is_active ,students.created_at ,students.updated_at,students.father_name,students.rte,students.admission_type,students.gender,' . $field_variable)->from('students');
        $this->db->join('student_session', 'student_session.student_id = students.id');
        $this->db->join('classes', 'student_session.class_id = classes.id');
        $this->db->join('sections', 'sections.id = student_session.section_id');
        $this->db->join('categories', 'students.category_id = categories.id', 'left');
        ...
        $this->db->or_where("students.id IN (SELECT student_id FROM student_certificate_register JOIN student_certificate_types ON student_certificate_types.id = student_certificate_register.student_certificate_type_id WHERE LOWER(student_certificate_types.certificate_name) LIKE '%transfer%' OR LOWER(student_certificate_types.certificate_name) LIKE '%tc%')", NULL, FALSE);
        $this->db->group_end();
        if ($class_id != null) {
            $this->db->where('student_session.class_id', $class_id);
        }
    ...
    public function searchusersbyFullText($searchterm, $carray = null, $limit = null)
    {
        $class_section_array = $this->customlib->get_myClassSection();
        $userdata            = $this->customlib->getUserData();
        $staff_id            = $userdata['id'];
        ...
        $this->db->or_like('students.middlename', $searchterm);
        $this->db->or_like('students.lastname', $searchterm);
        $this->db->or_like("CONCAT_WS(' ', students.firstname, students.lastname)", $searchterm, 'both', FALSE);
        $this->db->or_like("CONCAT_WS(' ', students.firstname, students.middlename, students.lastname)", $searchterm, 'both', FALSE);
        $this->db->or_like('school_houses.house_name', $searchterm);
        $this->db->or_like('students.guardian_name', $searchterm);
        $this->db->or_like('students.adhar_no', $searchterm);
        $this->db->or_like('students.samagra_id', $searchterm);
    ...
    {
        $this->db->select('students.*,classes.id as `class_id`,classes.class,sections.id as `section_id`,sections.section,student_session.session_id as `session_id`,student_session.id as `student_session_id`')->from('students');
        $this->db->join('student_session', 'student_session.student_id = students.id');
        $this->db->join('classes', 'student_session.class_id = classes.id');
        $this->db->join('sections', 'sections.id = student_session.section_id');
        $this->db->join('categories', 'students.category_id = categories.id', 'left');
    ...
    public function lastRecord()
    {
        $last_row = $this->db->select('*')
                             ->order_by('CAST(admission_no AS UNSIGNED)', "desc")
                             ->order_by('LENGTH(admission_no)', 'desc')
    ...
    public function searchdtStudentListCustom($class_id = null, $section_id = null, $category_id = null, $gender = null)
    {
        $userdata = $this->customlib->getUserData();
        $staff_id = $userdata['id'];
        $join_array    = "";
        ...
        if ($class_id != null && $class_id != "") {
            $class_section_ary[] = 'student_session.class_id=' . $this->db->escape($class_id);
        }
        if ($section_id != null && $section_id != "") {
            $class_section_ary[] = 'student_session.section_id=' . $this->db->escape($section_id);
        }
        if ($category_id != null && $category_id != "") {
            $class_section_ary[] = 'students.category_id=' . $this->db->escape($category_id);
        }
        if ($gender != null && $gender != "") {
            $class_section_ary[] = 'students.gender=' . $this->db->escape($gender);
        }
        ...
        $sql = "select * from (SELECT (SELECT GROUP_CONCAT(CONCAT(classes.class, '(', sections.section, ')') SEPARATOR ', ') FROM student_session JOIN classes ON student_session.class_id = classes.id JOIN sections ON sections.id = student_session.section_id  WHERE student_session.session_id = " . $this->current_session . " $class_section_where  AND student_session.student_id = students.id) AS class_section_list,`classes`.`id` AS `class_id`, `student_session`.`id` as `student_session_id`, `classes`.`class`, `sections`.`id` AS `section_id`, `sections`.`section`, `students`.`id`, `students`.`admission_no`, `students`.`roll_no`, `students`.`admission_date`, `students`.`firstname`, `students`.`middlename`, `students`.`lastname`, `students`.`image`, `students`.`mobileno`, `students`.`email`, `students`.`state`, `students`.`city`, `students`.`pincode`, `students`.`religion`, DATE(students.dob) as dob, `students`.`current_address`, `students`.`permanent_address`, IFNULL(students.category_id, 0) as `category_id`, IFNULL(categories.category, '') as `category`, `students`.`adhar_no`, `students`.`samagra_id`, `students`.`bank_account_no`, `students`.`bank_name`, `students`.`ifsc_code`, `students`.`father_name`, `students`.`guardian_name`, `students`.`guardian_relation`, `students`.`guardian_phone`, `students`.`guardian_address`, `students`.`is_active`, `students`.`created_at`, `students`.`updated_at`, `students`.`gender`, `students`.`rte`, `student_session`.`session_id`, `students`.`mother_name`, `students`.`blood_group`, `students`.`height`, `students`.`weight`, `students`.`measurement_date`, `students`.`previous_school` " . $field_variable . " FROM `students` JOIN `student_session` ON `student_session`.`student_id` = `students`.`id` JOIN `classes` ON `student_session`.`class_id` = `classes`.`id` JOIN `sections` ON `sections`.`id` = `student_session`.`section_id` JOIN `class_sections` ON `class_sections`.`class_id` = `classes`.`id` and `class_sections`.`section_id` = `sections`.`id` LEFT JOIN `categories` ON `students`.`category_id` = `categories`.`id` LEFT JOIN `school_houses` ON `students`.`school_house_id` = `school_houses`.`id` " . $join_array . " WHERE `student_session`.`session_id` = " . $this->current_session . " AND `students`.`is_active` = 'yes' " . $where_cls_clause . " GROUP BY students.id ORDER BY students.id DESC ) as new_students";
    ...
    public function getCustomExportData($class_id = null, $section_id = null, $category_id = null, $gender = null, $search_keyword = null)
    {
        $userdata = $this->customlib->getUserData();
        $staff_id = $userdata['id'];
        $join_array    = "";
        ...
        if ($search_keyword != null && $search_keyword != "") {
            $search_kw = $this->db->escape_like_str($search_keyword);
            $search_clause = " AND (`students`.`admission_no` LIKE '%$search_kw%' ESCAPE '!' OR `students`.`firstname` LIKE '%$search_kw%' ESCAPE '!' OR `students`.`middlename` LIKE '%$search_kw%' ESCAPE '!' OR `students`.`lastname` LIKE '%$search_kw%' ESCAPE '!' OR `students`.`roll_no` LIKE '%$search_kw%' ESCAPE '!' OR `students`.`father_name` LIKE '%$search_kw%' ESCAPE '!' OR `students`.`mobileno` LIKE '%$search_kw%' ESCAPE '!' ) ";
        }

        $sql = "select * from (SELECT (SELECT GROUP_CONCAT(CONCAT(classes.class, '(', sections.section, ')') SEPARATOR ', ') FROM student_session JOIN classes ON student_session.class_id = classes.id JOIN sections ON sections.id = student_session.section_id  WHERE student_session.session_id = " . $this->current_session . " $class_section_where  AND student_session.student_id = students.id) AS class_section_list,`classes`.`id` AS `class_id`, `student_session`.`id` as `student_session_id`, `classes`.`class`, `sections`.`id` AS `section_id`, `sections`.`section`, `students`.`id`, `students`.`admission_no`, `students`.`roll_no`, `students`.`admission_date`, `students`.`firstname`, `students`.`middlename`, `students`.`lastname`, `students`.`image`, `students`.`mobileno`, `students`.`email`, `students`.`state`, `students`.`city`, `students`.`pincode`, `students`.`religion`, DATE(students.dob) as dob, `students`.`current_address`, `students`.`permanent_address`, IFNULL(students.category_id, 0) as `category_id`, IFNULL(categories.category, '') as `category`, `students`.`adhar_no`, `students`.`samagra_id`, `students`.`bank_account_no`, `students`.`bank_name`, `students`.`ifsc_code`, `students`.`father_name`, `students`.`guardian_name`, `students`.`guardian_relation`, `students`.`guardian_phone`, `students`.`guardian_address`, `students`.`is_active`, `students`.`created_at`, `students`.`updated_at`, `students`.`gender`, `students`.`rte`, `student_session`.`session_id`, `students`.`mother_name`, `students`.`blood_group`, `students`.`height`, `students`.`weight`, `students`.`measurement_date`, `students`.`previous_school` " . $field_variable . " FROM `students` JOIN `student_session` ON `student_session`.`student_id` = `students`.`id` JOIN `classes` ON `student_session`.`class_id` = `classes`.`id` JOIN `sections` ON `sections`.`id` = `student_session`.`section_id` JOIN `class_sections` ON `class_sections`.`class_id` = `classes`.`id` and `class_sections`.`section_id` = `sections`.`id` LEFT JOIN `categories` ON `students`.`category_id` = `categories`.`id` LEFT JOIN `school_houses` ON `students`.`school_house_id` = `school_houses`.`id` " . $join_array . " WHERE `student_session`.`session_id` = " . $this->current_session . " AND `students`.`is_active` = 'yes' " . $where_cls_clause . $search_clause . " GROUP BY students.id ORDER BY students.id DESC ) as new_students";
...
FROM `students`
 ...
 AND `students`.`admission_no` =" . $this->db->escape($admission_no);
    ...
    public function getStudentDashboardStats($date = null)
    {
        if ($date == null) {
            $date = date('Y-m-d');
        }
        ...
        // 2. Gender Ratio
        $this->db->select('students.gender, count(students.id) as count');
        $this->db->from('students');
        $this->db->join('student_session', 'student_session.student_id = students.id');
        $this->db->where('student_session.session_id', $session_id);
        $this->db->where('students.is_active', 'yes');
        $this->db->group_by('students.gender');
        $gender_ratio = $this->db->get()->result_array();

        $gender_stats = ['Male' => 0, 'Female' => 0];
        foreach ($gender_ratio as $g) {
            $gender = ucfirst(strtolower($g['gender']));
            if(isset($gender_stats[$gender])) {
                $gender_stats[$gender] = $g['count'];
            }
        }

        // 3. Category Distribution
        $this->db->select('categories.category, count(students.id) as count');
        $this->db->from('students');
        $this->db->join('student_session', 'student_session.student_id = students.id');
        $this->db->join('categories', 'students.category_id = categories.id', 'left');
        $this->db->where('student_session.session_id', $session_id);
        ...
        $category_ratio = $this->db->get()->result_array();

        $category_stats = [];
        foreach ($category_ratio as $c) {
            $cat = $c['category'] ? $c['category'] : 'Uncategorized';
            $category_stats[$cat] = $c['count'];
        }

        // 4. Class-wise Students
        $this->db->select('classes.class, count(students.id) as count');
        $this->db->from('students');
        $this->db->join('student_session', 'student_session.student_id = students.id');
        $this->db->join('classes', 'student_session.class_id = classes.id');
        $this->db->where('student_session.session_id', $session_id);
        ...
        $class_wise_res = $this->db->get()->result_array();

        $class_wise = [];
        foreach ($class_wise_res as $c) {
            $class_wise[$c['class']] = $c['count'];
        }

        // 5. RTE Students
        $this->db->select('count(students.id) as count');
        $this->db->from('students');
        $this->db->join('student_session', 'student_session.student_id = students.id');
        $this->db->where('student_session.session_id', $session_id);
        $this->db->where('students.is_active', 'yes');
        $this->db->where('students.rte', 'Yes');
        $rte_students = $this->db->get()->row()->count;
        ...
        $this->db->where('students.is_active', 'yes');
        $this->db->where("DATE_FORMAT(students.dob,'%m-%d') = DATE_FORMAT('" . $date . "','%m-%d')");
        $birthdays_today = $this->db->get()->row()->count;

        // 6.a Birthdays Today List
        $this->db->select('students.firstname, students.lastname, classes.class, sections.section');
        $this->db->from('students');
        $this->db->join('student_session', 'student_session.student_id = students.id');
        $this->db->join('classes', 'student_session.class_id = classes.id');
        $this->db->join('sections', 'student_session.section_id = sections.id');
        ...
        $this->db->where('students.is_active', 'yes');
        $this->db->where("DATE_FORMAT(students.dob,'%m-%d') = DATE_FORMAT('" . $date . "','%m-%d')");
        $birthdays_list = $this->db->get()->result_array();

        // 7. New Admissions (This Month)
        $this->db->select('count(students.id) as count');
        $this->db->from('students');
        $this->db->join('student_session', 'student_session.student_id = students.id');
        $this->db->where('student_session.session_id', $session_id);
        $this->db->where('students.is_active', 'yes');
        $this->db->where("DATE_FORMAT(students.admission_date,'%Y-%m') = DATE_FORMAT('" . $date . "','%Y-%m')");
        $new_admissions = $this->db->get()->row()->count;

        // 8. Attendance Today
        $this->db->select('attendence_type.type, count(student_attendences.id) as count');
        ...
        $this->db->group_by('attendence_type.type');
        $attendance_res = $this->db->get()->result_array();

        $attendance_today = ['Present' => 0, 'Absent' => 0, 'Late' => 0, 'Half Day' => 0];
        $total_present = 0;
        foreach ($attendance_res as $a) {
            $attendance_today[$a['type']] = $a['count'];
            if($a['type'] == 'Present' || $a['type'] == 'Late' || $a['type'] == 'Half Day'){
                 $total_present += $a['count'];
            }
        }
