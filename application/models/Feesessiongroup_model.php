...
class Feesessiongroup_model extends MY_Model
{
    ...
    public function getFeesByGroupByStudent($student_session_id, $class_id = null)
    {
        ...
        if ($class_id != null) {
            $this->db->join('fee_groups_classes', 'fee_groups_classes.fee_groups_id = fee_groups.id');
            $this->db->where('fee_groups_classes.class_id', $class_id);
        }
    ...
    public function getFeesByGroup($id = null,$display_system=NULL, $class_id = null){
