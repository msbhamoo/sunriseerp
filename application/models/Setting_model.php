...
class Setting_model extends MY_Model {
    ...
    public function getSchoolDetail($id = null) {
        ...
        $this->db->select('sch_settings.id,sch_settings.base_url,sch_settings.folder_path,sch_settings.lang_id,sch_settings.is_rtl,sch_settings.timezone,
          sch_settings.name,sch_settings.email,sch_settings.biometric,sch_settings.biometric_device,sch_settings.phone,languages.language,sch_settings.address,sch_settings.dise_code,sch_settings.date_format,sch_settings.currency,sch_settings.start_month,sch_settings.start_week,sch_settings.session_id,sch_settings.image,sch_settings.theme,sessions.session,sch_settings.online_admission,sch_settings.maintenance_mode,currencies.symbol as currency_symbol,currencies.base_price,currencies.short_name as currency,sch_settings.sign_principal,sch_settings.sign_vice_principal,sch_settings.sign_class_teacher,sch_settings.sign_exam_incharge,sch_settings.sign_academic_coordinator,sch_settings.sign_headmaster,sch_settings.sign_manager,sch_settings.sign_secretary,sch_settings.sign_director,sch_settings.sign_chairman,sch_settings.sign_admin_officer,sch_settings.sign_accounts_officer,sch_settings.sign_admission_incharge,sch_settings.sign_cbse_coordinator,sch_settings.sign_school_seal,sch_settings.sign_principal_staff,sch_settings.sign_vice_principal_staff,sch_settings.sign_class_teacher_staff,sch_settings.sign_exam_incharge_staff,sch_settings.sign_academic_coordinator_staff,sch_settings.sign_headmaster_staff,sch_settings.sign_manager_staff,sch_settings.sign_secretary_staff,sch_settings.sign_director_staff,sch_settings.sign_chairman_staff,sch_settings.sign_admin_officer_staff,sch_settings.sign_accounts_officer_staff,sch_settings.sign_admission_incharge_staff,sch_settings.sign_cbse_coordinator_staff,sch_settings.sign_school_seal_staff');
        $this->db->from('sch_settings');
        $this->db->join('sessions', 'sessions.id = sch_settings.session_id');
        $this->db->join('languages', 'languages.id = sch_settings.lang_id');
        $this->db->join('currencies', 'currencies.id = sch_settings.currency');
