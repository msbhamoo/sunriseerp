...
class Hostelgatepass_model extends MY_Model
{
    ...
    {
        $this->db->select('hostel_gate_pass.*, students.firstname, students.lastname, students.admission_no, students.father_name, students.mother_name, classes.class as class_name, sections.section as section_name');
