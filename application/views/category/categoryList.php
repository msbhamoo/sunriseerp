        ...
        <div class="row">
            <div class="col-md-2">
                <div class="box border0">
                                        <ul class="tablists">
                        <li><a href="<?php echo site_url('category') ?>" class="active"><?php echo $this->lang->line('student_categories') ? $this->lang->line('student_categories') : 'Student Categories'; ?></a></li>
