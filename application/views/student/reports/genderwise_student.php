...
<div class="content-wrapper">
        ...
        <div class="row" style="display:flex; align-items:center; justify-content:space-between; margin-bottom: 20px;">
            <div class="col-md-8">
                <div class="title-area">
                    ...
                    <h2>Gender Wise Student</h2>
                </div>
                <div class="breadcrumb-custom">Home > Student > Gender-wise-student</div>
            </div>
    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-body">
                <form action="<?php echo site_url('studentreport/genderwise'); ?>" method="POST">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Gender <small class="req"> *</small></label>
