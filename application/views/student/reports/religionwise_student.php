...
<div class="content-wrapper">
        ...
        <div class="row" style="display:flex; align-items:center; justify-content:space-between; margin-bottom: 20px;">
            <div class="col-md-8">
                <div class="title-area">
                    ...
                    <h2>Religion Wise Student</h2>
                </div>
                <div class="breadcrumb-custom">Home > Student > Religion-wise-student</div>
            </div>
    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-body">
                <form action="<?php echo site_url('studentreport/religionwise'); ?>" method="POST">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Religion <small class="req"> *</small></label>
                                <select class="form-control" name="religion" required>
                                    <option value="">Select</option>
                                    <option value="Hindu" <?php echo (isset($religion) && $religion == 'Hindu') ? 'selected' : ''; ?>>Hindu</option>
                                    <option value="Muslim" <?php echo (isset($religion) && $religion == 'Muslim') ? 'selected' : ''; ?>>Muslim</option>
                                    <option value="Christian" <?php echo (isset($religion) && $religion == 'Christian') ? 'selected' : ''; ?>>Christian</option>
                                    <option value="Sikh" <?php echo (isset($religion) && $religion == 'Sikh') ? 'selected' : ''; ?>>Sikh</option>
                                    <option value="Buddhist" <?php echo (isset($religion) && $religion == 'Buddhist') ? 'selected' : ''; ?>>Buddhist</option>
                                    <option value="Jain" <?php echo (isset($religion) && $religion == 'Jain') ? 'selected' : ''; ?>>Jain</option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <?php $d = (isset($as_on_date)) ? date($this->customlib->getSchoolDateFormat(), strtotime($as_on_date)) : date($this->customlib->getSchoolDateFormat()); ?>
                                <input type="text" class="form-control date" name="as_on_date" value="<?php echo $d; ?>" required readonly>
                            </div>
                        </div>
                        <div class="col-md-2">
                ...
                <?php if (isset($results) && $this->input->server('REQUEST_METHOD') === 'POST') { ?>
