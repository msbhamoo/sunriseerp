...
<div class="content-wrapper">
        ...
        <div class="row" style="display:flex; align-items:center; justify-content:space-between; margin-bottom: 20px;">
            <div class="col-md-8">
                <div class="title-area">
                    ...
                    <h2>Category Wise Student</h2>
                </div>
                <div class="breadcrumb-custom">Home > Student > Category-wise-student</div>
            </div>
    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-body">
                <form action="<?php echo site_url('studentreport/categorywise'); ?>" method="POST">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Category <small class="req"> *</small></label>
                                <select class="form-control" name="category_id" required>
                                    <option value="">Select</option>
                                    <?php foreach ($category_list as $category) { ?>
                                        <option value="<?php echo $category['id'] ?>" <?php echo (isset($category_id) && $category_id == $category['id']) ? 'selected' : ''; ?>><?php echo $category['category'] ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
