...
<div class="content-wrapper">
    <section class="content-header">
        <div class="row" style="display:flex; align-items:center; justify-content:space-between; margin-bottom: 20px;">
            <div class="col-md-8">
                ...
                <div class="breadcrumb-custom">Home > Student > New Admissions</div>
            </div>
    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-body">
                <form action="<?php echo site_url('studentreport/newadmissions'); ?>" method="POST">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Date From <small class="req"> *</small></label>
                                <?php $d1 = (isset($from_date)) ? date($this->customlib->getSchoolDateFormat(), strtotime($from_date)) : date($this->customlib->getSchoolDateFormat()); ?>
                                <input type="text" class="form-control date" name="from_date" value="<?php echo $d1; ?>" required readonly>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Date To <small class="req"> *</small></label>
                                <?php $d2 = (isset($to_date)) ? date($this->customlib->getSchoolDateFormat(), strtotime($to_date)) : date($this->customlib->getSchoolDateFormat()); ?>
                                <input type="text" class="form-control date" name="to_date" value="<?php echo $d2; ?>" required readonly>
                            </div>
                        </div>
                        <div class="col-md-2">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-custom-header">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="6" class="text-center text-danger">No admissions found in this period</td>
                            </tr>
                            <?php } else {
                                $count = 1;
