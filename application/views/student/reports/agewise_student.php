<style>
    ...
    .table-custom-header thead th {
        background-color: #4caf50; /* Green header from mockup */
        color: white;
...
<div class="content-wrapper">
        ...
        <div class="row" style="display:flex; align-items:center; justify-content:space-between; margin-bottom: 20px;">
            <div class="col-md-8">
                <div class="title-area">
                    ...
                    <h2>Age Wise Student</h2>
                </div>
                <div class="breadcrumb-custom">Home > Student > Age-wise-student</div>
            </div>
    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-body">
                <form action="<?php echo site_url('studentreport/agewise'); ?>" method="POST">
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Age From <small class="req"> *</small></label>
                                <select class="form-control" name="min_age" required>
                                    <option value="">Select</option>
                                    <?php for($i=1; $i<=25; $i++) { ?>
                                        <option value="<?php echo $i; ?>" <?php echo (isset($min_age) && $min_age == $i) ? 'selected' : ''; ?>><?php echo $i; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Age To <small class="req"> *</small></label>
                                <select class="form-control" name="max_age" required>
                                    <option value="">Select</option>
                                    <?php for($i=1; $i<=25; $i++) { ?>
                                        <option value="<?php echo $i; ?>" <?php echo (isset($max_age) && $max_age == $i) ? 'selected' : ''; ?>><?php echo $i; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#studentListOverlay').click(function() {
            closeOffcanvas();
        });
    });
