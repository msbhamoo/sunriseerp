            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('bank_book_report'); ?></h3>
                    </div>
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('accounts/reports/bankbook') ?>" method="post">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="ledger_id" class="form-control">
                                            ...
                                            <?php foreach ($bank_ledgers as $ledger) { ?>
            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo $this->lang->line('bank_book_report'); ?></h3>
                        <div class="box-tools pull-right"></div>
                    </div>
                    <div class="box-body table-responsive">
                        <div class="download_label"><?php echo $this->lang->line('bank_book_report'); ?></div>
                        <style>
                        ...
                        <table class="table table-striped table-bordered table-hover report-table">
                            ...
                            <tbody>
                                ...
                                if (!empty($result) || isset($opening_balances)) {
                                    $bank_opening = isset($opening_balances) ? $opening_balances['bank'] : null;
                                    
                                    if ($bank_opening !== null) {
                                    ...
                                    $bank_closing = isset($closing_balances) ? $closing_balances['bank'] : null;
                                    
                                    if ($bank_closing !== null) {
