...
// $count++;
    ...
    ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="default_value" name="default_value" placeholder="" type="text" class="form-control"  value="<?php echo set_value('default_value', isset($cus_field->default_value) ? $cus_field->default_value : ''); ?>" />
