                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        ...
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#registerAddonModal"><i class="fa fa-plus"></i> Register Custom Addon</button>
                        </div>
...
<!-- Register Custom Addon Modal -->
<div id="registerAddonModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Register Custom Addon</h4>
            </div>
            <form id="registerAddonForm" method="post" action="<?php echo base_url('admin/addons/register_custom'); ?>">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="addon_name">Addon Name <small class="req"> *</small></label>
                        <input type="text" class="form-control" name="name" id="addon_name" required>
                    </div>
                    <div class="form-group">
                        <label for="product_id">Product ID <small class="req"> *</small></label>
                        <input type="text" class="form-control" name="product_id" id="product_id" required>
                        <small class="text-danger">Must exactly match the "product_id" inside addon_info.json.</small>
                    </div>
                    <div class="form-group">
                        <label for="directory">Directory Name <small class="req"> *</small></label>
                        <input type="text" class="form-control" name="directory" id="directory" required>
                        <small class="text-danger">Must exactly match the folder name inside the zip file.</small>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="description">Description <small class="req"> *</small></label>
                        <textarea class="form-control" name="description" id="description" rows="3" required></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" id="btnRegisterAddon" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('please_wait'); ?>">Save</button>
                </div>
            </form>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        $("#registerAddonForm").on('submit', (function(e) {
            e.preventDefault();
            let form = $(this);
...
let update_addon=(product_id,directory)=>{
    ...
    $(document).on('click', '.delete_custom', function(e) {
        if (confirm('Are you sure you want to completely remove this addon registration from the database?')) {
            e.preventDefault();
            let _button = $(this);
            let product_id = _button.data('productId');
            ...
            _button.button('loading');
            $.ajax({
                url: base_url + 'admin/addons/delete_custom',
                type: "POST",
                data: {
                    'product_id': product_id
                },
