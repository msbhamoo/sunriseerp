                        ...
                        <div class="rate2">
                                        <div class="d-flex align-items-start mb-xl-3 mb-2">
                                            <div class="ms-auto mr-sm-auto">
                                                ...
                                                ?>
                                                    <?php if(!empty($content_value->article_link)): ?>
                                                    <a target="_blank" href="<?php echo $content_value->article_link ; ?>" class="btn btn-primary btn-xs "><?php echo $this->lang->line('buy_now');?></a>
                                                    <?php endif; ?>
                                                    <button type="button" data-product-id="<?php echo $content_value->product_id; ?>" class="btn btn-danger btn-xs delete_custom" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('please_wait'); ?>"><i class="fa fa-trash"></i> Remove</button>
                                                <?php
