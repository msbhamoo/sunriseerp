            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <h4 class="pagetitleh2 around10"><?php echo $this->lang->line('fees_details'); ?></h4>
                    ...
                    <div class="box-table-card mb25">
                        <h4 class="pagetitleh2 around10"><?php echo $this->lang->line('transport_fees_details'); ?></h4>
                    ...
                    <div class="box-table-card mb25">
                     <h4 class="pagetitleh2 around10"><?php echo $this->lang->line('student_admission'); ?></h4>
                      <div class="table-responsive mt5">
                        <table class="table table-hover mb5 table-striped table-bordered">
                            <thead>
                                <tr>
                    ...
                    <div class="box-table-card mb25">
                       <h4 class="pagetitleh2 around10"><?php echo $this->lang->line('library_details'); ?></h4>
                      <div class="table-responsive mt5">
                        <table class="table table-hover mb5 table-striped table-bordered">
                            <thead>
                                <tr>
                    ...
                    <div class="box-table-card mb25">
                      <h4 class="pagetitleh2 around10"><?php echo $this->lang->line('alumni_students'); ?></h4>
                      <div class="table-responsive mt5">
                        <table class="table table-hover mb5 table-striped table-bordered">
                            <thead>
                                <tr>
                    ...
                    <div class="box-table-card mb25">
                     <h4 class="pagetitleh2 around10"><?php echo $this->lang->line('staff_payroll_of'); ?> <?php echo $this->lang->line(strtolower($month)) ; ?> </h4>
                      <div class="table-responsive mt5">
                        <table class="table table-hover mb5 table-striped table-bordered">
                            <thead>
                                <tr>
                    ...
                    <div class="box-table-card mb25">
                    <h4 class="pagetitleh2 around10"><?php echo $this->lang->line('staff_attendance_details'); ?> <?php echo $this->customlib->dateformat(date("Y/m/d")) ?> </h4>
                    ...
                    <div class="box-table-card mb25">
                      <h4 class="pagetitleh2 around10"><?php echo $this->lang->line('user_log_details'); ?></h4>
                      <div class="table-responsive mt5">
                        <table class="table table-hover mb5 table-striped table-bordered">
                            <thead>
                                <tr>
