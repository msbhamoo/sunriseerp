...
<div class="alert alert-info"><b>Available Placeholders:</b> {{student_name}}, {{parent_name}}, {{admission_no}}, {{class}}, {{section}}, {{category}}, {{total_fee}}, {{remaining_fee}}, {{route}}, {{pickup_point}}, {{hostel_details}}<br><b>WhatsApp formatting:</b> *bold*, _italic_, ~strikethrough~</div>
                <div class="nav-tabs-custom theme-shadow">
                    <ul class="nav nav-tabs pull-right">
                        <li class="pull-left header w-xs-100"><?php echo $this->lang->line('send_whatsapp'); ?></li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                 <label><?php echo $this->lang->line('whatsapp_template'); ?></label>
                                                 <select name="template_id" id="template_id" class="form-control">
                                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                     <?php foreach ($whatsapp_template_list as $whatsapp_template_list_value) {?>
                                                        <option value="<?php echo $whatsapp_template_list_value['id']; ?>"><?php echo $whatsapp_template_list_value['title']; ?></option>
                                                     <?php }?>
                                                 </select>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
<div><small><i>WhatsApp formatting: *bold*, _italic_, ~strikethrough~</i></small></div>
...
<div><small><i>WhatsApp formatting: *bold*, _italic_, ~strikethrough~</i></small></div>
                                                <label><?php echo $this->lang->line('message'); ?></label><small class="req"> *</small>
                                                <textarea id="birthday_msg_text" name="birthday_message" class="form-control compose-textarea " cols="35" rows="20"><?php echo set_value('message'); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
...
<script type="text/javascript">
    $('#template_id').change(function(){
        ...
        $.ajax({
            url : '<?php echo base_url(); ?>admin/mailsms/whatsapptemplatedata',
            type: 'post',
