                        ...
                        <form action="<?php echo site_url("admin/feegroup/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="class_id[]" multiple="multiple" data-placeholder="<?php echo $this->lang->line('select'); ?>">
                                        <?php 
                                        $selected_classes = set_value('class_id') ? set_value('class_id') : (isset($mapped_classes) ? $mapped_classes : array());
                                        foreach ($classlist as $class) { ?>
                                            <option value="<?php echo $class['id']; ?>" <?php if (in_array($class['id'], $selected_classes)) { echo "selected='selected'"; } ?>><?php echo $class['class']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div><!-- /.box-body -->
