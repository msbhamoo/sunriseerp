                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="class_id[]" multiple="multiple" data-placeholder="<?php echo $this->lang->line('select'); ?>">
                                        <?php foreach ($classlist as $class) { ?>
                                            <option value="<?php echo $class['id']; ?>" <?php if (set_value('class_id') && in_array($class['id'], set_value('class_id'))) { echo "selected='selected'"; } ?>><?php echo $class['class']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div><!-- /.box-body -->
                                ...
                                <tbody>
                                    ...
                                    foreach ($feegroupList as $feegroup) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name">
                                                <?php 
                                                $class_names = $this->feegroup_model->get_mapped_class_names($feegroup['id']);
