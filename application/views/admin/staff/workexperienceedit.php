                ...
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('admin/workexperience/workexperience') ?>" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <input type="hidden" name="workexperienceid" value="<?php echo $workexperience['id']; ?>">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Work Experience Title</label><small class="req"> *</small>
                                <input autofocus="" id="type" name="type" placeholder="" type="text" class="form-control" value="<?php echo set_value('type', $workexperience['work_experience']); ?>" />
