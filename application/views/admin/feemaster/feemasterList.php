                                        ...
                                        ?>
                                            <tr>
                                                <td class="mailbox-name">
                                                    ...
                                                    <?php
                                                    $CI =& get_instance();
                                                    $class_names = $CI->feegroup_model->get_mapped_class_names($feegroup->fee_groups_id);
                                                    if (!empty($class_names)) {
                                                        echo "<br/><small class='text-muted'><b>" . $this->lang->line('class') . ":</b> " . implode(", ", $class_names) . "</small>";
                                                    }
                                                    ?>
                                                </td>
                                                <td class="mailbox-name">
