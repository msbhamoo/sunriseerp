...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .new-btn-submit { width: 100%; padding: 14px; font-size: 16px; font-weight: 600; color: #ffffff; background: linear-gradient(135deg, #fbc18c 0%, #f6a05a 100%); border: none; border-radius: 10px; cursor: pointer; transition: transform 0.2s, box-shadow 0.2s; display: flex; align-items: center; justify-content: center; margin-top: 30px; }
                ...
                <div class="new-login-right">
                    ...
                    <form action="<?php echo site_url('site/forgotpassword') ?>" method="post">
                        ...
                        <div class="new-form-group">
                            ...
                            <input type="text" name="email" value="" class="new-form-control" id="form-username" placeholder="name@company.com" autocomplete="off">
                            <span class="text-danger" style="font-size: 12px;"><?php echo form_error('email'); ?></span>
                        </div>
                    ...
                    <div style="text-align: center; margin-top: 20px;">
                        <a href="<?php echo site_url('site/login') ?>" style="color: #718096; font-size: 14px; font-weight: 500; text-decoration: none;"><i class="fa fa-arrow-left"></i> Back to <?php echo $this->lang->line('admin_login'); ?></a>
                    </div>
