            ...
            <div class="">
                <ul class="reportlists">                 
                    ...
                    <?php if ($this->rbac->hasPrivilege('subject_marks_report', 'can_view')) { ?>                        
                        ...
                        <li class="col-lg-4 col-md-4 col-sm-6  <?php echo set_SubSubmenu('cbse_exam/rollnumber'); ?>"><a href="<?php echo site_url('cbseexam/report/rollnumber'); ?>"><i class="fa fa-id-card-o"></i>Exam Roll Number & Admit Card Report</a></li>
