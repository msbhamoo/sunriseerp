...
<div class="box-header ptbnull">
    ...
    foreach ($results as $key => $value) {   
        ...
        foreach ($value as $collect) {           
            ...
            $t               = two_digit_float($collect['amount']) + two_digit_float($collect['amount_fine']);
...
$count++;
        if ($subtotal) {
            ?>
                                            <tr>
                                                ...
                                                <td class="text text-right" style="font-weight:bold"><?php echo $currency_symbol.amountFormat(array_sum($amountLabel)); ?></td>
                                                <td class="text text-right" style="font-weight:bold" ><?php echo $currency_symbol.amountFormat(array_sum($discountLabel)); ?></td>
                                                <td class="text text-right" style="font-weight:bold" ><?php echo $currency_symbol.amountFormat(array_sum($fineLabel)); ?></td>
                                                <td class="text text-right " style="font-weight:bold" ><?php echo $currency_symbol.amountFormat(array_sum($TotalLabel)); ?></td>
                                            </tr>
                                            <?php
}
    ...
    ?>
                                        <tr>
                                            ...
                                            <td class="text text-right" style="font-weight:bold"><?php echo $currency_symbol.amountFormat(array_sum($grdamountLabel)); ?></td>
                                            <td class="text text-right" style="font-weight:bold" ><?php echo $currency_symbol.amountFormat(array_sum($grddiscountLabel)); ?></td>
                                            <td class="text text-right" style="font-weight:bold" ><?php echo $currency_symbol.amountFormat(array_sum($grdfineLabel)); ?></td>
