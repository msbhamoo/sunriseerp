            ...
            <div class="">
                <ul class="reportlists">
                    ...
                    <?php  }  if ($this->rbac->hasPrivilege('balance_fees_report', 'can_view')) {  ?>
                        ...
                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/class_summary_report'); ?>"><a href="<?php echo base_url(); ?>financereports/class_summary_report"><i class="fa fa-file-text-o"></i> Class Summary Report</a></li>
                    ...
                    <?php   }  if ($this->rbac->hasPrivilege('fees_collection_report', 'can_view')) {   ?>
                        ...
                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/collection_list'); ?>"><a href="<?php echo base_url(); ?>financereports/collection_list"><i class="fa fa-file-text-o"></i> Fee Collection List</a></li>
