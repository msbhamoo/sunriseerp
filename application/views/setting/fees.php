                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <h4 class="session-head">Custom Receipt Series</h4>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label class="col-sm-5">Common Fee Prefix <br/><small class="text-muted">(Optional)</small></label>
                                                    <div class="col-sm-7">
                                                        <input type="text" name="common_prefix" id="common_prefix" class="form-control" value="<?php echo $custom_receipt_settings->common_prefix; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label class="col-sm-5">Common Fee Start Number<small class="req"> *</small></label>
                                                    <div class="col-sm-7">
                                                        <input type="number" name="common_start" id="common_start" class="form-control" value="<?php echo $custom_receipt_settings->common_start; ?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label class="col-sm-5">Current Series Number</label>
                                                    <div class="col-sm-7">
                                                        <input type="text" class="form-control" value="<?php echo $custom_receipt_settings->common_prefix . $custom_receipt_settings->common_current; ?>" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label class="col-sm-5">Transport Fee Prefix <br/><small class="text-muted">(Optional)</small></label>
                                                    <div class="col-sm-7">
                                                        <input type="text" name="transport_prefix" id="transport_prefix" class="form-control" value="<?php echo $custom_receipt_settings->transport_prefix; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label class="col-sm-5">Transport Fee Start Number<small class="req"> *</small></label>
                                                    <div class="col-sm-7">
                                                        <input type="number" name="transport_start" id="transport_start" class="form-control" value="<?php echo $custom_receipt_settings->transport_start; ?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label class="col-sm-5">Current Series Number</label>
                                                    <div class="col-sm-7">
                                                        <input type="text" class="form-control" value="<?php echo $custom_receipt_settings->transport_prefix . $custom_receipt_settings->transport_current; ?>" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
