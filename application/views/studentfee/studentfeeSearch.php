                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <form role="form" action="<?php echo site_url('studentfee/search') ?>" method="post" class="class_search_form">
...
$(document).on('submit','.class_search_form',function(e){
    ...
    var search_type = form.find('input[name="search_type"]').val();
  ...
  },
  {
    ...
    $(document).on('keydown', '#search_text', function () {
        clearTimeout(typingTimer);
    });
