...
if (!empty($transport_fees)) {
    foreach ($transport_fees as $transport_fee_key => $transport_fee_value) {
        ...
        <?php }  ?>
                ...
                <?php 
                    if($student_due_fee['session_id'] == $current_session_id['session_id']){ ?>
                        <input class="checkbox fee_checkbox_session" type="checkbox" name="fee_checkbox" data-fee_master_id="0" data-fee_session_group_id="0" data-fee_groups_feetype_id="0" data-fee_category="<?php echo isset($transport_fee_value->fee_category) ? $transport_fee_value->fee_category : 'transport'; ?>"  data-trans_fee_id="<?php echo $transport_fee_value->id; ?>">
                <?php } ?>
                </td>
                <td align="left" class="text-rtl-right"><?php echo isset($transport_fee_value->fee_category) && $transport_fee_value->fee_category == 'transport_yearly' ? $this->lang->line('transport_fees')." (Yearly)" : $this->lang->line('transport_fees')." (".$this->lang->line(strtolower($transport_fee_value->month)).")"; ?></td>
                ...
                <td class="white-space-nowrap"><?php
                    if($student_due_fee['session_id'] == $current_session_id['session_id']){
				    if ($this->rbac->hasPrivilege('collect_fees', 'can_add')) { ?>
                        <button type="button" data-student_session_id="<?php echo $transport_fee_value->student_session_id; ?>" data-student_fees_master_id="0" data-fee_groups_feetype_id="0"  data-group="<?php echo isset($transport_fee_value->fee_category) && $transport_fee_value->fee_category == 'transport_yearly' ? $this->lang->line('transport_fees')." (Yearly)" : $this->lang->line('transport_fees'); ?>"  data-type="<?php echo isset($transport_fee_value->fee_category) && $transport_fee_value->fee_category == 'transport_yearly' ? 'Yearly' : $transport_fee_value->month; ?>" class="btn btn-xs btn-default myCollectFeeBtn <?php echo $display_none; ?>"  title="<?php echo $this->lang->line('add_fees'); ?>" data-toggle="modal" data-target="#myFeesModal"  data-fee_session_group_id="0"   data-fee-category="<?php echo isset($transport_fee_value->fee_category) ? $transport_fee_value->fee_category : 'transport'; ?>" data-trans_fee_id="<?php echo $transport_fee_value->id; ?>"><i class="fa fa-plus"></i></button><?php } ?>

                        <button  class="btn btn-xs btn-default printInv"  data-student_session_id="<?php echo $transport_fee_value->student_session_id; ?>" data-fee_master_id="0" data-fee_session_group_id="0" data-fee_groups_feetype_id="0" data-fee-category="<?php echo isset($transport_fee_value->fee_category) ? $transport_fee_value->fee_category : 'transport'; ?>"  data-trans_fee_id="<?php echo $transport_fee_value->id; ?>" title="<?php echo $this->lang->line('print'); ?>" data-loading-text="<i class='fa fa-spinner fa-spin '></i>"><i class="fa fa-print"></i></button>
                    <?php } ?>
                </td>
            </tr>
                                                        ...
                                                        <td class="text text-right">
                                                            ...
                                                            <div class="btn-group ">
                                                               <div class="pull-right">
                                                                ...
                                                                <?php }?>
                                                                    <button  class="btn btn-xs btn-default printDoc" data-fee-category="<?php echo isset($transport_fee_value->fee_category) ? $transport_fee_value->fee_category : 'transport'; ?>" data-main_invoice="<?php echo $transport_fee_value->student_fees_deposite_id ?>" data-sub_invoice="<?php echo $fee_deposits_value->inv_no ?>"  title="<?php echo $this->lang->line('print'); ?>"><i class="fa fa-print"></i></button>
                                                                </div>
                                                            </div>
                                                            <?php } ?>
                                                        </td>
