...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .new-login-right h2 { font-size: 28px; font-weight: 700; color: #1a202c; margin-top: 0; margin-bottom: 8px; }
            .new-login-right p.subtitle { font-size: 15px; color: #718096; margin-bottom: 30px; }
            ...
            .new-form-group label a { color: #3182ce; text-decoration: none; text-transform: none; font-size: 13px; font-weight: 600; }
            ...
            .new-btn-submit i { margin-left: 10px; transition: transform 0.2s; }
            .new-btn-submit:hover i { transform: translateX(5px); }
            ...
            .password-toggle { position: absolute; right: 15px; top: 38px; color: #a0aec0; cursor: pointer; }
        ...
        <div class="new-login-wrapper">
            <div class="new-login-card">
                ...
                <div class="new-login-right">
                    ...
                    <h2><?php echo $this->lang->line('user_login'); ?></h2>
                    <p class="subtitle">Access your portal to continue learning.</p>

                    <!-- Alerts -->
                    <?php if (isset($error_message)) { echo "<div class='alert alert-danger new-alert'>" . $error_message . "</div>"; } ?>
                    <?php if ($this->session->flashdata('message')) { echo "<div class='alert alert-success new-alert'>" . $this->session->flashdata('message') . "</div>"; } ?>
                    ...
                    <form action="<?php echo site_url('site/userlogin') ?>" method="post">
                        ...
                        <div class="new-form-group">
                            ...
                            <input type="text" name="username" value="<?php echo set_value("username"); ?>" class="new-form-control" id="email" placeholder="Enter username" autocomplete="off">
                        ...
                        <div class="new-form-group">
                            ...
                            <input type="password" name="password" value="<?php echo set_value("password"); ?>" class="new-form-control" id="password" placeholder="Enter password" autocomplete="off">
                        ...
                        <?php if ($is_captcha) { ?>
                        <div class="new-form-group" style="display: flex; gap: 15px; align-items: flex-end;">
                            <div style="flex: 1;">
                                <label><?php echo $this->lang->line('captcha'); ?></label>
                                <input type="text" name="captcha" placeholder="<?php echo $this->lang->line('captcha'); ?>" autocomplete="off" class="new-form-control" id="captcha">
                                <span class="text-danger" style="font-size: 12px;"><?php echo form_error('captcha'); ?></span>
                            </div>
                            <div style="flex: 1; display: flex; align-items: center; gap: 10px;">
                                <span id="captcha_image" style="background: #f7fafc; padding: 5px; border-radius: 8px; border: 1px solid #e2e8f0; display: inline-block;"><?php echo $captcha_image; ?></span>
                                <span class="fa fa-refresh" style="cursor: pointer; color: #fbc18c; font-size: 20px;" title="<?php echo $this->lang->line('refresh_captcha') ?>" onclick="refreshCaptcha()"></span>
                            </div>
                        </div>
                        <?php } ?>
