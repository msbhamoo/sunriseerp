...
class Mailgateway
{
    ...
    public function getGroupAddFeeContent($data, $template)
    {
        ...
        } elseif ($invoice_value['fee_category'] == "transport_yearly") {

            $fee = $this->_CI->studentfeemaster_model->getTransportYearlyFeeByInvoice($invoice_value['invoice_id'], $invoice_value['sub_invoice_id']);
    ...
    public function sentAddFeeMail($detail, $template, $subject, $send_to)
    {
        ...
        } elseif ($copy->fee_category == "transport_yearly") {
            $fee = $this->_CI->studentfeemaster_model->getTransportYearlyFeeByInvoice($copy->invoice_id, $copy->sub_invoice_id);
        } else {
    ...
    public function getAddFeeContent($data, $template)
    {
        ...
        } elseif ($data->fee_category == "transport_yearly") {

            $fee = $this->_CI->studentfeemaster_model->getTransportYearlyFeeByInvoice($data->invoice_id, $data->sub_invoice_id);
