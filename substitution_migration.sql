...
VALUES 
((SELECT id FROM sidebar_menus WHERE `lang_key` = 'academics'), 'Substitute Planning', 'substitution_planning', 'substitution_planning', 'admin/substitution', 99, '(\'class_timetable\', \'can_view\')', NULL, 'substitution', 'index', '', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
((SELECT id FROM sidebar_menus WHERE `lang_key` = 'academics'), 'Substitution History', 'substitution_history', 'substitution_history', 'admin/substitution/history', 100, '(\'class_timetable\', \'can_view\')', NULL, 'substitution', 'history', '', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
