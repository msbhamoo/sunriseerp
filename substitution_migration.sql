...
VALUES 
((SELECT id FROM sidebar_menus WHERE `key` = 'academics'), 'Substitute Planning', 'substitution_planning', 'substitution_planning', 'admin/substitution', 99, '(\'class_timetable\', \'can_view\')', 1, '', '', '', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
((SELECT id FROM sidebar_menus WHERE `key` = 'academics'), 'Substitution History', 'substitution_history', 'substitution_history', 'admin/substitution/history', 100, '(\'class_timetable\', \'can_view\')', 1, '', '', '', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
