...
INSERT IGNORE INTO `permission_group` (`id`, `name`, `short_code`, `is_active`, `system`, `created_at`) VALUES
...
INSERT IGNORE INTO `roles_permissions` (`id`, `role_id`, `perm_cat_id`, `can_view`, `can_add`, `can_edit`, `can_delete`, `created_at`) VALUES 
...
(10200, 1000, 'Consolidated Accounting Report', 'multi_branch_accounting_report', 1, 0, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT IGNORE INTO `roles_permissions` (`id`, `role_id`, `perm_cat_id`, `can_view`, `can_add`, `can_edit`, `can_delete`, `created_at`) VALUES 
(null, 1, 10008, 1, 0, 0, 0, CURRENT_TIMESTAMP),
(null, 7, 10008, 1, 0, 0, 0, CURRENT_TIMESTAMP),
(null, 1, 10200, 1, 0, 0, 0, CURRENT_TIMESTAMP),
(null, 7, 10200, 1, 0, 0, 0, CURRENT_TIMESTAMP);